...
class Dehaze(object):
    ...
    def _init_images(self):
        ...
        self.images_torch = np_to_torch(self.image).type(torch.FloatTensor)
    ...
    def _init_inputs(self):
        self.image_net_inputs = np_to_torch(self.image).cpu()
        self.mask_net_inputs = np_to_torch(self.image).cpu()
        self.ambient_net_input = np_to_torch(self.image).cpu()
...
def dehaze(image_name, image, num_iter=100, output_path="output/"):
...
if __name__ == "__main__":
    ...
    for i in os.listdir("D:/2020-TIP-ZID/gt_data"):
        print(i)
        hazy_img = prepare_hazy_image("hazy_data/" + i.split(".")[0] + "_hazy.jpg")
        dehaze(i.split(".")[0], hazy_img, output_path="output/")
